...
def update_queue(start_pos, end_pos, queue, ladder=None, snake=None, steps=5):
    ...
    if ladder:
        ...
        queue.extend(interpolate_movement(calculate_position(start_pos)[0], calculate_position(start_pos)[1],
                                          ladder_start_x, ladder_start_y, steps))
        ...
        queue.extend(interpolate_movement(calculate_position(start_pos)[0], calculate_position(start_pos)[1],
                                          snake_start_x, snake_start_y, steps))
