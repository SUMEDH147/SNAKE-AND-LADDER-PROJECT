...
game_started = False
running = True
dice_images = [pygame.image.load('/Users/sirishapulupula/Downloads/dice1.png'), pygame.image.load('/Users/sirishapulupula/Downloads/dice2.png'), pygame.image.load('/Users/sirishapulupula/Downloads/dice3.png'),
               pygame.image.load('/Users/sirishapulupula/Downloads/dice4.png'), pygame.image.load('/Users/sirishapulupula/Downloads/dice5.png'), pygame.image.load('/Users/sirishapulupula/Downloads/dice6.png')]
...
snakes = [{"start": 17, "end": 1}, {"start": 52, "end": 29}, {"start": 62, "end": 19}, {"start": 88, "end": 36}, {"start": 95, "end": 42}, {"start": 97, "end": 79}, {"start": 99, "end": 46}]
ladders = [{"start": 3, "end": 20}, {"start": 6, "end": 14}, {"start": 11, "end": 28}, {"start": 15, "end": 34}, {"start": 22, "end": 38}, {"start": 44, "end": 59}, {"start": 77, "end": 98}]
player1_x = 30
...
while running:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if play_button_rect.collidepoint(event.pos):
                ...
                running = False
            elif dice_button_rect.collidepoint(event.pos) and game_started:
    ...
    if not game_started:
        ...
        for ladder in ladders:
            ...
            pygame.draw.line(screen, (0, 255, 0), (start_x1, start_y), (end_x1, end_y), 5)
            pygame.draw.line(screen, (0, 255, 0), (start_x2, start_y),(end_x2,end_y),5)
        if rolled_dice is not None:
            screen.blit(dice_images[rolled_dice - 1], (screen_width - dice_button_width - 20, 20))
        ...
        if player1_target_x is not None and player1_target_y is not None:
            ...
            if abs(player1_x - player1_target_x) < 5 and abs(player1_y - player1_target_y) < 5:
        ...
        if player2_target_x is not None and player2_target_y is not None:
            player2_x += (player2_target_x - player2_x) / player2_move_speed
            player2_y += (player2_target_y - player2_y) / player2_move_speed
            if abs(player2_x - player2_target_x) < 5 and abs(player2_y - player2_target_y) < 5:
                player2_x = player2_target_x
                player2_y = player2_target_y
                player2_target_x = None
                player2_target_y = None

        pygame.draw.ellipse(screen, black, dice_button_rect, 2)
        dice_button_text = font.render("Roll Dice", True, black)
        screen.blit(dice_button_text, (dice_button_x + dice_button_width // 2 - dice_button_text.get_width() // 2, dice_button_y + dice_button_height // 2 - dice_button_text.get_height() // 2))
