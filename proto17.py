...
player1_target_pos=player1_pos
player2_target_pos=player2_pos
player_moving=False
while running:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if play_button_rect.collidepoint(event.pos):
                ...
                running=False
            elif game_started and dice_button_rect.collidepoint(event.pos)and not player_moving:
                rolled_dice = random.randint(1, 6)
                player_moving=True
                if player1_pos==player1_target_pos and player2_pos==player2_target_pos:
                    player_moving=False
    ...
    if not game_started:
        ...
        if player1_pos<player1_target_pos:
            player1_pos+=1
        elif player1_pos>player1_target_pos:
            player1_pos-=1
        if player2_pos<player2_target_pos:
            player2_pos+=1
        elif player2_pos>player2_target_pos:
            player2_pos-=1
