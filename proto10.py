...
while running:
    ...
    if not game_started:
        ...
        player1_y = screen_height - (((player1_pos - 1) // 10) % 10 + 1) * box_size + 30
        if (player1_pos - 1) // 10 % 2 == 1:
            player1_x = (9 - ((player1_pos - 1) % 10)) * box_size + 30
        ...
        player2_x = ((player2_pos - 1) % 10) * box_size + 60
        player2_y = screen_height - (((player2_pos - 1) // 10) % 10 + 1) * box_size + 30
        if (player2_pos - 1) // 10 % 2 == 1:
            player2_x = (9 - ((player2_pos - 1) % 10)) * box_size + 60
